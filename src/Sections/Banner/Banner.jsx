...
const Banner = () => {
    return (
        < >
            <div className="px-3 py-5 md:py-0 md:px-6 lg:px-0 min-h-screen flex items-center" style={{
                ...
                <div className="flex items-center justify-between max-w-6xl mx-auto py-20" >
                    <div className="w-full text-center md:text-left md:w-7/12 text-[#F0F3BD] ">
                        ...
                        <div className="flex gap-5 justify-center md:justify-normal">
                            <a href="/public/resume/Ikmat-Resume.pdf" download="AIkmat-Resume.pdf" className="btn btn-outline border-[#00A896] text-xs hover:bg-[#02C39A]  text-[#F0F3BD] rounded-full uppercase hover:scale-105 hover:border-[#02C39A] ">download resume</a>
